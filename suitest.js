...
const switchContextFactory = require('./lib/chains/switchContextChain');
...
const CONTEXT = require('./lib/constants/context');
...
class SUITEST_API extends EventEmitter {
	constructor({exitOnError} = {}) {
		...
		const {switchContext} = switchContextFactory(this);
