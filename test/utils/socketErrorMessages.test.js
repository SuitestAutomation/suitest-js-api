...
describe('Socket error messages', () => {
	...
	it('Error message should return specific messages', () => {
		...
		[
			...
			[basePayload('invalidCredentials'), 'The device could not be reached. Please check that network control is enabled and you\'re using the correct password.'],
			[basePayload('networkControlDisabled'), 'The device could not be reached. Please check that network control is enabled and you\'re using the correct password.'],
