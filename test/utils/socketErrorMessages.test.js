...
describe('Socket error messages', () => {
	...
	it('Error message should return specific messages', () => {
		...
		[
			...
			[basePayload('queryFailed', 'exprException'), 'JavaScript error: undefined.'],
			[basePayload('queryFailed', 'orderErr'), 'Suitest instrumentation library should be placed as the first script in your HTML file. Loading the instrumentation library dynamically or after other scripts have loaded may cause many unsual errors.'],
