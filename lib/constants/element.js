...
const ELEMENT_PROP = {
	...
	ACCESSIBILITY_IDENTIFIER:   Symbol('accessibilityIdentifier'),
	BADGE_COLOR:                Symbol('badgeColor'),
	BADGE_VALUE:                Symbol('badgeValue'),
	BAR_TINT_COLOR:             Symbol('barTintColor'),
	CONTENT_MODE:               Symbol('contentMode'),
	IMAGE_HASH:                  Symbol('imageHash'),
	FONT_NAME:                  Symbol('fontName'),
	HAS_META_DATA:              Symbol('hasMetaData'),
	HAS_NAV_MARKERS:            Symbol('hasNavMarkers'),
	IS_FOCUSED:                 Symbol('isFocused'),
	IS_OPAQUE:                  Symbol('isOpaque'),
	NUMBER_OF_SEGMENTS:         Symbol('numberOfSegments'),
	PLACEHOLDER:                Symbol('placeholder'),
	PROPOSAL_URL:               Symbol('proposalUrl'),
	SELECTED_IMAGE_TINT_COLOR:  Symbol('selectedImageTintColor'),
	STATE:                      Symbol('state'),
	TEXT_ALIGNMENT:             Symbol('textAlignment'),
	LEFT_ABSOLUTE:              Symbol('leftAbsolute'),
	TAG_INT:                    Symbol('tagInt'),
	TINT_COLOR:                 Symbol('tintColor'),
	TOP_ABSOLUTE:               Symbol('topAbsolute'),
};
