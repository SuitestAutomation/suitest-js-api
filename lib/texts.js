...
module.exports = {
	...
	elementTap: template`Executing ${0} tap on "${1}"`,
	elementScroll: template`Scrolling from "${0}" to ${1} by ${2}px`,
	elementSwipe: template`Swipe/Flick from "${0}" to ${1} by ${2}px in ${3}ms`,
	...
	positionTap: template`Executing ${0} tap at [${1}, ${2}]`,
	positionScroll: template`Scrolling from [${0}, ${1}] to ${2} by ${3}px`,
	positionSwipe: template`Swipe/Flick from [${0}, ${1}] to ${2} by ${3}px in ${4}ms`,
	...
	takeScreenshotError: () => 'Failed to take screenshot',

	saveScreenshot: () => 'Saving screenshot',
...
${leaves}`,
	...
	'errorType.initPlatformFailed': () => 'Failed to bootstrap platform on this device.',
	...
	'errorType.timeLimitExceeded': template`Test execution time limit exceeded. Contact us at sales@suite.st if you need to run longer tests. ${0}`,
	...
	'errorType.adbError': () => 'ADB communication with the device has failed. Make sure your device is set up correctly and it can be connected to using ADB.',
	'errorType.adbError.certificateError': () => 'Unable to parse the application signing certificate. Make sure your app package is signed and the certificate is valid.',
	'errorType.configuratorError': () => 'Make sure that Apple Configurator 2 and Automation Tools are installed. Please see our docs.',
	'errorType.appleNetworkLogsError': () => 'SuitestDrive can\'t launch NetworkLog service on Mac',
	'errorType.appStoreBuild': () => 'Can’t install App Store distribution build.',
	'errorType.screenshot.notSupportedDriver': () => 'Screenshots are not supported on this device.',
	'errorType.screenshot.notSupportedIL': () => 'Screenshots are not supported with this instrumentation library version.',
	'errorType.screenshot.timeout': () => 'Failed to take a screenshot due to timeout.',
	'errorType.screenshot.generalError': () => 'Failed to take a screenshot.',
	'errorType.ioError': () => 'Problem with storing data. Please check that there is enough disk space and that permissions are not limited. Contact support (mailto:support@suite.st) if problem persists.',
	'errorType.netError': () => 'Downloading of the driver failed, please check your internet connection and try again later. Contact support (mailto:support@suite.st) if problem persists.',
	'errorType.sdComponentFailed': () => 'Downloading of the driver failed, please try again later. Contact support (mailto:support@suite.st) if problem persists.',
	'errorType.MoveTargetOutOfBounds': () => 'Move target is outside of the visible area of the screen.',
	'errorType.ElementClickIntercepted': () => 'Click on the element was intercepted by another element.',
	'errorType.unsupportedOSVersion': () => 'Unsupported OS version, please see our docs (https://suite.st/docs/devices/playstation/#sdk-650-or-system-software-701-or-lower).',
	'errorType.targetManagerUnsupportedVersion': () => 'Unsupported Target Manager Server, please see our docs (https://suite.st/docs/devices/playstation/#sdk-650-or-system-software-701-or-lower).',
	'errorType.systemOutdated': () => 'System software version mismatch. New version of system software is required.',
