...
module.exports = {
	...
	unknownError: () => 'Unknown error occurred. If you keep getting this error please get in touch with support@suite.st. If you haven\'t turned off automatic error reporting (the sentry option in config) we are already working hard to fix it.',
	// Auth errors
...
${leaves}`,
	...
	'errorType.initPlatformFailed': template`Failed to initialize device (Suitest base application). ${0}`,
	...
	'errorType.driverException': () => 'Device failed',
	...
	'errorType.queryFailed.applicationError': template`Application error occurred while executes command "${0}".`,
	...
	'errorType.exit': () => 'Application testing was exited.',
	...
	'errorType.openAppOverrideFailed': () => 'Open app override failed.',
