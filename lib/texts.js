...
${leaves}`,
	...
	'errorType.networkControlDisabledOrInvalidCredentials': () => 'The device could not be reached. Please check that network control is enabled and you\'re using the correct password.',
	...
	'notStartedReason.noAvailableAutomatedMinutes': () => 'Cannot continue: you\'ve used up all of your automation minutes',
	'notStartedReason.noAvailableAutomatedMinutesDesc': () => 'You automate a lot! How about getting a bigger subscription https://the.suite.st/preferences/billing? Or, if you would like to purchase more automation minutes for the current billing cycle, please contact sales@suite.st. Your automation minutes will renew',
