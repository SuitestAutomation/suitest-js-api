...
module.exports = {
	...
	executeBrightScrip: template`Executing BrightScript:\n${0}`,
	...
	elementMatchBS: template`Checking if "${0}" matches BrightScript:\n${1}`,
	elementNotExist: template`Checking if "${0}" is missing`,
	elementNotMatchJS: template`Checking if "${0}" does not match JS:\n${1}`,
	elementNotMatchBS: template`Checking if "${0}" does not match BrightScript:\n${1}`,
