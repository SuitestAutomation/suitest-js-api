...
module.exports = {
	...
	unknownError: () => 'Unknown Suitest error occurred.' +
		' Our developers are notified if sentry option is turned on.' +
		' If Error repeats, please contact us via support@suite.st.',
	// Auth errors
...
${leaves}`,
	...
	'interactiveProgress.status.closingApp': () => 'Trying to open app...',
	'interactiveProgress.status.bootingDevice': () => 'Running the boot sequence defined for the device...',
	'interactiveProgress.status.needManual': () => 'Paused. Manual action required, check below.',
	...
	'interactiveProgress.code.xboxPlatformError': () => 'Cannot continue: LG WebOS driver failed.',
};
