...
${leaves}`,
	...
	warnInteractiveRepl: () => 'Ignored the "interactive" command. Run the test in interactive mode with --repl flag for the command to work.',
	...
	cliTimestamp: () => `Logger timestamp format. Use "${timestamp.none}" to disable. [default: "${timestamp.default}"]`,
