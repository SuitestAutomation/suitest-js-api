...
${leaves}`,
	...
	'tl.newVersionAvailable': template`The new version of suitest library is available (${0}).`,
	...
	'errorType.executeThrowException': template`JavaScript expression error: "${0}".`,
	'errorType.matchJSThrowException': template`JavaScript expression error: "${0}".`,
