...
${leaves}`,
	...
	cliLogLevelTestLines: () => `Logger verbosity level for test lines [default: "${logLevels.normal}"]`,
	cliLogLevelTestErrors: () => `Logger verbosity level for test errors [default: "${logLevels.normal}"]`,
	cliLogLevelNetworkLogs: () => `Logger verbosity level for network logs [default: "${logLevels.normal}"]`,
	cliLogLevelConsoleLogs: () => `Logger verbosity level for console logs [default: "${logLevels.normal}"]`,
	cliLogLevelDebug: () => 'Adds extra internal logs [default: "false"]',
	cliLogLevelTestLauncher: () => `Logger verbosity level for test launcher logs [default: "${logLevels.normal}"]`,
