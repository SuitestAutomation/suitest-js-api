...
module.exports = {
	...
	invalidConfiguration: () => 'The application configuration is invalid. Please select a valid configuration or fix the selected one.',
	configNotFound: () => 'Application specification is incomplete - see https://suite.st/docs/application/setting-up-vidaa-apps/#specify-the-application in our documentation for more details.',
