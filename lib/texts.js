...
${leaves}`,
	...
	'errorType.appleError65': () => 'Unable to launch WebDriverAgent because of xcodebuild failure: "xcodebuild failed with code 65".',
	'errorType.appleError70': () => 'Unable to launch WebDriverAgent because of xcodebuild failure: "xcodebuild failed with code 70".',
	'errorType.appleEconnresetError': () => 'Unable to start WebDriverAgent session because of xcodebuild failure: "Could not proxy command to remote server".',
	'errorType.applePairingError': () => 'Pairing failed. Try restarting both device and Mac.',
	'errorType.appleIosDeployError': () => 'Could not initialize ios-deploy make sure it is installed (npm install -g ios-deploy) and works on your system.',
	'errorType.appleAppSignError': () => 'Could not install app.',
