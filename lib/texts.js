...
${leaves}`,
	...
	connectToDevice: (name) => `Connected to device "${name}"`,
	disconnectFromDevice: () => 'Disconnected from device',
	startTestMsg: (name) => `Test ${name} was started`,
	startTestPackMsg: (name) => `Test pack ${name} was started`,
