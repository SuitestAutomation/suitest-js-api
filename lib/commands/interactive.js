 ...
 * @param {{ignored: *, watch: *, repeater: Function? cwd: String?, vars: Array?}} opts
 * @returns {*[]}
 */
function getReplParameters(opts) {
...
async function interactive(opts = {}) {
	...
	const [vars, cwd, watch] = getReplParameters(opts);
