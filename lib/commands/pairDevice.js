 ...
 * @param {string} recording - optional, should be 'autostart' | 'manualstart' | 'none'
...
async function pairDevice(
	...
	const recordingOption = config.recording || recording;

	const webhookUrlOption = config.webhookUrl || webhookUrl;
