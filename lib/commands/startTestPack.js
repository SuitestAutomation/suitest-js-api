...
const {invalidInputMessage, authFailed, testWillBeStarted, testWasStarted} = require('../texts');
...
async function startTestPack(testPackData) {
	logVerboseMessage(testWillBeStarted(testPackData.testPackId));
	...
	logVerboseMessage(testWasStarted(testPackData.testPackId));
