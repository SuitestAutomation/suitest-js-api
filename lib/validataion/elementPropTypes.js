// const {ELEMENT_PROP: ELEMENT_PROP} = require('../mappings');
const {ELEMENT_PROP} = require('../constants/element');

const ELEMENT_PROP_TYPES = {
	[ELEMENT_PROP.ALPHA]: 'integer',
	...
	[ELEMENT_PROP.BORDER_STYLE]: 'string',
	...
	[ELEMENT_PROP.VIDEO_STATE]: 'string',
	[ELEMENT_PROP.VIDEO_URL]: 'string',
	[ELEMENT_PROP.VISIBILITY]: 'string',
	[ELEMENT_PROP.WIDTH]: 'integer',
	...
	[ELEMENT_PROP.CONTENT_MODE]: 'string',
	[ELEMENT_PROP.DATA_SIZE]: 'integer',
	...
	[ELEMENT_PROP.STATE]: 'string',
	[ELEMENT_PROP.TEXT_ALIGNMENT]: 'string',
	[ELEMENT_PROP.LEFT_ABSOLUTE]: 'integer',
	[ELEMENT_PROP.TAG_INT]: 'integer',
	[ELEMENT_PROP.TINT_COLOR]: 'string',
	[ELEMENT_PROP.TOP_ABSOLUTE]: 'integer',
	[ELEMENT_PROP.NUMBER_OF_SEGMENTS]: 'integer',
};
