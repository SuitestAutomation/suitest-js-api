...
const ELEMENT_PROP_TYPES = {
	...
	[ELEMENT_PROP.BORDER_STYLE]: `symbol enum [${Object.keys(BORDER_STYLE).join(', ')}]`,
	...
	[ELEMENT_PROP.VIDEO_STATE]: `symbol enum [${Object.keys(VIDEO_STATE).join(', ')}]`,
	[ELEMENT_PROP.VIDEO_URL]: 'string',
	[ELEMENT_PROP.VISIBILITY]: `symbol enum [${Object.keys(VISIBILITY_STATE).join(', ')}]`,
	[ELEMENT_PROP.WIDTH]: 'number',
	[ELEMENT_PROP.Z_INDEX]: 'integer',
	[ELEMENT_PROP.ACCESSIBILITY_IDENTIFIER]: 'string',
	[ELEMENT_PROP.BADGE_COLOR]: 'string',
	[ELEMENT_PROP.BADGE_VALUE]: 'string',
	[ELEMENT_PROP.BAR_TINT_COLOR]: 'string',
	[ELEMENT_PROP.CONTENT_MODE]: `symbol enum [${Object.keys(CONTENT_MODE).join(', ')}]`,
	...
	[ELEMENT_PROP.STATE]: `symbol enum [${Object.keys(ELEMENT_STATE).join(', ')}]`,
	[ELEMENT_PROP.TEXT_ALIGNMENT]: `symbol enum [${Object.keys(TEXT_ALIGNMENT).join(', ')}]`,
...
const ELEMENT_PROP_BY_TYPE = Object.getOwnPropertySymbols(ELEMENT_PROP_TYPES).reduce((map, s) => ({
	...map,
