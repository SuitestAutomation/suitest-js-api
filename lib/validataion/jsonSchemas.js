...
schemas[validationKeys.START_TEST] = {
	...
	'required': ['name'],
	'properties': {
		'name': {'type': 'string'}, // Name given to test by user
		'clientTestId': {'type': 'string'}, // Optional client test id - can be used to organize historical data on our end, must be unique per test run. Test name used otherwise
		'description': {'type': 'string'}, // Optional test description
		'appVersion': {'type': 'string'}, // Optional version of the application in test
		'commitHash': {'type': 'string'}, // Optional commit hash for the app in test
	},
};
...
schemas[validationKeys.CONFIGURE] = {
	...
	'properties': {
		...
		...schemas[validationKeys.TEST_LAUNCHER_INTERACTIVE].properties,
		...schemas[validationKeys.TEST_LAUNCHER_AUTOMATED].properties,
	},
};
