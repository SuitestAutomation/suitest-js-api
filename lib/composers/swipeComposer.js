...
const swipeComposer = makeModifierComposer(composers.TAP, ['swipe', 'flick'], (_, meta, direction, distance, duration) => ({
	...
	distance: validate(validators.ST_VAR_NOT_NEGATIVE_NUMBER, distance, invalidInputMessage('swipe/flick', 'distance')),
	duration: validate(validators.ST_VAR_NOT_NEGATIVE_NUMBER, duration, invalidInputMessage('swipe/flick', 'duration')),
}));
