...
const isPlayingComposer = makeModifierComposer(composers.MATCH, ['isPlaying'], data => ({
	...data,
	comparator: {
...
const isStoppedComposer = makeModifierComposer(composers.MATCH, ['isStopped'], data => ({
	...data,
	comparator: {
		type: SUBJ_COMPARATOR.MATCH,
		props: [{
...
const isPausedComposer = makeModifierComposer(composers.MATCH, ['isPaused'], data => ({
	...data,
	comparator: {
		type: SUBJ_COMPARATOR.MATCH,
		props: [{
