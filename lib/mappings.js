...
// Roku
VRC[VRC[vrcConstants.REPLAY] = 'REPLAY'] = vrcConstants.REPLAY;
...
ELEMENT_PROP[ELEMENT_PROP[elConstants.ELEMENT_PROP.FONT_URI] = 'fontURI'] = elConstants.ELEMENT_PROP.FONT_URI;
...
ELEMENT_PROP[ELEMENT_PROP[elConstants.ELEMENT_PROP.ITEM_FOCUSED] = 'itemFocused'] = elConstants.ELEMENT_PROP.ITEM_FOCUSED;
...
/**
 * Creates a single map of all symbols involved so that translations can be made
 * @param obj
 * @param acc
 * @returns Object
 */
function flatten(obj, acc) {
	const allProps = Object.keys(obj).concat(Object.getOwnPropertySymbols(obj));

	allProps.forEach(function(prop) {
		if (typeof obj[prop] === 'object')
			flatten(obj[prop], acc);
...
module.exports = {
	...allSymbols,
	getAllSymbols: flatten(allSymbols, {}),
};
