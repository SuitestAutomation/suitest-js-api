...
// xBox-specific
VRC[VRC[vrcConstants.A] = 'ENTER'] = vrcConstants.A;
VRC[VRC[vrcConstants.B] = 'BACK'] = vrcConstants.B;
VRC[VRC[vrcConstants.X] = 'BLUE'] = vrcConstants.X;
VRC[VRC[vrcConstants.Y] = 'YELLOW'] = vrcConstants.Y;
...
VRC[VRC[vrcConstants.DPAD_RIGHT] = 'RIGHT'] = vrcConstants.DPAD_RIGHT;
VRC[VRC[vrcConstants.DPAD_LEFT] = 'LEFT'] = vrcConstants.DPAD_LEFT;
VRC[VRC[vrcConstants.DPAD_DOWN] = 'DOWN'] = vrcConstants.DPAD_DOWN;
VRC[VRC[vrcConstants.DPAD_UP] = 'UP'] = vrcConstants.DPAD_UP;
...
ELEMENT_PROP[ELEMENT_PROP[elConstants.ELEMENT_PROP.BADGE_COLOR] = 'badgeColor'] = elConstants.ELEMENT_PROP.BADGE_COLOR;
ELEMENT_PROP[ELEMENT_PROP[elConstants.ELEMENT_PROP.BADGE_VALUE] = 'badgeValue'] = elConstants.ELEMENT_PROP.BADGE_VALUE;
...
ELEMENT_PROP[ELEMENT_PROP[elConstants.ELEMENT_PROP.DATA_SIZE] = 'dataSize'] = elConstants.ELEMENT_PROP.DATA_SIZE;
...
STATE[STATE[states.SELECTED] = 'selected'] = states.SELECTED;
STATE[STATE[states.HIGHLIGHTED] = 'highlighted'] = states.HIGHLIGHTED;
STATE[STATE[states.DISABLED] = 'disabled'] = states.DISABLED;
STATE[STATE[states.NORMAL] = 'normal'] = states.NORMAL;
STATE[STATE[states.APPLICATION] = 'application'] = states.APPLICATION;
STATE[STATE[states.FOCUSED] = 'focused'] = states.FOCUSED;
STATE[STATE[states.RESERVED] = 'reserved'] = states.RESERVED;
