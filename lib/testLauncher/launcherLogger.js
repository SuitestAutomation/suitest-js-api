...
const launcherLogger = {
	...
	_err: (txt, devId) => console.log(stColors.errorColor(devicePrefix(devId)) + stColors.errorColor(txt)),
...
function deviceLines(devicesLines, deviceId) {
	...
	devicesLines.forEach(log => launcherLogger._(log, deviceId));
