...
const getComposers = (data) => {
	...
	if (!data.isNegated && !data.isClick && !data.isMoveTo && !data.sendText && !data.setText && !isMatchesComparator) {
	...
	if (!data.comparator && !data.isClick && !data.isMoveTo && !data.sendText && !data.setText && !data.isNegated) {
		output.push(clickComposer, moveToComposer, sendTextComposer, setTextComposer);
	}
