...
const getComposers = (data) => {
	...
	if (!data.isNegated && !data.isClick && !data.isMoveTo && !data.sendText && !isMatchesComparator && !isVisibleComparator) {
	...
	if (!data.comparator && !data.isClick && !data.isMoveTo && !data.sendText) {
		...
		if (!data.isNegated) {
			output.push(visibleComposer, matchComposer, matchRepoComposer, matchJSComposer);
		}
	}
