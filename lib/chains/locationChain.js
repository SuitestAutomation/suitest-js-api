...
const {SUBJ_COMPARATOR_HR, SUBJ_COMPARATOR_HR_N, SUBJ_COMPARATOR} = require('../mappings');
const {
...
const beforeSendMsg = (data) => logger.info(chainIsAboutToBeExecuted('location()', toString(data)));
