...
const brightScriptExpressionChain = jsOrString => makeChain(getComposers, {
...
module.exports = {
	...
	brightScriptExpressionAssert: jsOrString => brightScriptExpressionChain(jsOrString).toAssert(),
