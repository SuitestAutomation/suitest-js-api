...
const validatorsMap = {
	...
	[validationKeys.SET_ORIENTATION]: (value, text) => {
		return validators.validateJsonSchema(validationKeys.SET_ORIENTATION, value, text);
	},
	...
	[validationKeys.TAP_TYPE]: (value, text) => {
		return validators.validateJsonSchema(validationKeys.TAP_TYPE, value, text);
	},
