...
const validatorsMap = {
	...
	[validationKeys.CHANGE_DEVICE_STATE_ACTION]: (value, text) => {
		return validators.validateJsonSchema(validationKeys.CHANGE_DEVICE_STATE_ACTION, value, text);
	},
	...
	[validationKeys.PASSCODE]: (value) => {
		return validators.validatePasscode(value);
	},
};
