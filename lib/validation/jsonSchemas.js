...
schemas[validationKeys.CONFIGURE] = {
	...
	'properties': {
		...
		'logLevelTestLines': {'enum': ['silent', 'normal', 'verbose', 'debug', 'silly']},
		'logLevelTestErrors': {'enum': ['silent', 'normal', 'verbose', 'debug', 'silly']},
		'logLevelNetworkLogs': {'enum': ['silent', 'normal', 'verbose', 'debug', 'silly']},
		'logLevelConsoleLogs': {'enum': ['silent', 'normal', 'verbose', 'debug', 'silly']},
		'logLevelTestLauncher': {'enum': ['silent', 'normal', 'verbose', 'debug', 'silly']},
		'logLevelDebug': {'type': 'boolean'},
		'orgId': {'type': 'string'},
		'password': {'type': 'string'},
		'repl': {'type': 'boolean'},
