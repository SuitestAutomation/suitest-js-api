...
const errorMap = {
	...
	psImplicitVideo: () => t['errorType.psImplicitVideo'](),
};
...
const notStartedReasons = {
	...
	'missingPSSDK': {
		translation: t['errorType.missingPSSDK'](),
		details: '',
	},
	'targetManagerBusy': {
		translation: t['errorType.targetManagerBusy'](),
		details: '',
	},
	'missingDotNet': {
		translation: t['errorType.missingDotNet'](),
		details: '',
	},
};
