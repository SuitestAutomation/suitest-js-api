...
const errorMap = {
	...
	// only for js-api
	notSupportedDriver: () => t['errorType.notSupportedDriver'](),
	// only for js-api
	notSupportedIL: () => t['errorType.notSupportedIL'](),
	// only for js-api
	timeout: () => t['errorType.timeout'](),
	// only for js-api
	generalError: () => t['errorType.generalError'](),
};
