...
const {getErrorMessage, getInfoErrorMessage, normalizeErrorType} = require('./socketErrorMessages');
 ...
 * @returns {number}
 */
const getTimeoutValue = data => Number.isFinite(data.timeout) && data.timeout >= 0 ? data.timeout : config.defaultTimeout;
