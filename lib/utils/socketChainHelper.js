		...
		if (isSuccess) {
			if (isSnippet) {
				const snippet = getSnippetLogs({
					...
					verbosity: mapLogLevelsToTranslationModule[verbosity ? verbosity.testLines : undefined] || mapLogLevelsToTranslationModule[verbosity ? verbosity.logLevel : undefined],
